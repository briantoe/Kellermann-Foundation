...
CREATE TABLE IF NOT EXISTS `bwindihospital_reduced`.`hmis` (
	...
	`villageId` VARCHAR(20) NULL DEFAULT NULL,
	`villageName` VARCHAR(20) NULL DEFAULT NULL,
	`matPhoneNumber` VARCHAR(50) NULL DEFAULT NULL,
	`age` INT(10) NULL DEFAULT NULL,
	`gravida` INT(5) NULL DEFAULT NULL,
	`parity` INT(5) NULL DEFAULT NULL,
	`gestation` INT(2) NULL DEFAULT NULL,
	`germ` VARCHAR(1) NULL DEFAULT NULL,
	...
	`matNutrCouns` VARCHAR(10) NULL DEFAULT NULL,
